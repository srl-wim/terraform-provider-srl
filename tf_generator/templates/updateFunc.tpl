{{define "updatefunc"}}
func resource{{ .ResourceName }}Update(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	log.Printf("[DEBUG] %s: beginning update", resource{{ .ResourceName }}String(d))
